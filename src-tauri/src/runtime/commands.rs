...
fn validate_download_target(target: &str) -> Result<(&'static str, &'static str), String> {
    match target {
        ...
        "luming-genie-tts-v2-pro-plus" => Ok(("luming-genie-tts-v2-pro-plus", "鹿鸣 Genie-TTS v2 Pro+")),
        "luming-gsv-lite-v2-pro-plus" => Ok(("luming-gsv-lite-v2-pro-plus", "鹿鸣 GSV-Lite v2 Pro+")),
